...
- **Último commit upstream revisado/portado:** `b5d23c5` — *ebula-v57 (Estaciones y Estado de Red)* (08-06-2026)
...
2. `git log b5d23c5..upstream/main --oneline`
3. `git diff b5d23c5 upstream/main -- index.html sw.js manifest.webmanifest boxann.js`
